      ...
      <main className="max-w-md mx-auto p-4 space-y-6">
        ...
        <div className="bg-gradient-to-br from-[#232526] to-[#18181b] border-2 border-yellow-400 rounded-2xl shadow-xl p-6 text-center mb-4">
          ...
          <div className="text-sm text-yellow-100 space-y-1">
            <div>• Premier League Players = <span className="font-bold text-yellow-400">4 Points</span> <span className="text-red-400 font-bold">4x Bonus</span></div>
            <div>• Ultimate Cards = <span className="font-bold text-yellow-400">3 Points</span></div>
            <div>• GOAT Pack = <span className="font-bold text-yellow-400">15 Points</span></div>
