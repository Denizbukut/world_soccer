...
<div className="w-full max-w-lg mx-auto mt-4 flex gap-4">
  {/* Profilkarte */}
  <div className="flex-shrink-0 w-[220px] h-[170px] bg-white rounded-xl shadow-md border border-gray-100 p-4 flex flex-col items-center justify-center">
    {/* Avatar */}
  ...
  {/* Game Pass */}
  <Link href="/pass" className="flex-shrink-0 w-[220px] h-[170px]">
  ...
  {/* XP Booster */}
  <Link href="/xp-booster" className="flex-shrink-0 w-[220px] h-[170px]">
