...
export const WEEKLY_CONTEST_CONFIG = {
  ...
  contestEnd: "2026-01-25T18:59:59Z",
  ...
  prizePool: [
    ...
    { rank: "4th–6th Place", reward: "Puskas Lvl. 6 + 150 Icon Tickets", icon: "🎖️" },
    { rank: "7th–10th Place", reward:"Beckenbauer Lvl. 5 + 50 Icon Tickets", icon: "🎖️" },
  ]
} as const
